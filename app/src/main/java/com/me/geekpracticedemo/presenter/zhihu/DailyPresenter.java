...
public class DailyPresenter extends RxPresenter<DailyContract.View> implements DailyContract.Presenter {
    ...
    private void registerEvent() {
        ...
        .observeOn(Schedulers.io())  //为了网络请求切换IO线程
        ...
        .map(new Function<DailyBeforeListBean, DailyBeforeListBean>() {
            @Override
            public DailyBeforeListBean apply(DailyBeforeListBean dailyBeforeListBean) throws Exception {
    ...
    public void getDailyData() {
        addSubscribe( mDataManager.fetchDailyListInfo()
                     ...
                     @Override
                     public DailyListBean apply(DailyListBean dailyListBean) throws Exception {
